...
- [下载 macOS · Apple 芯片](https://github.com/yumao3623/GitHub-Starter-Village/releases/download/v0.2.0/GitHubStarterVillage-0.2.0-darwin-arm64.zip)；文件名：`GitHubStarterVillage-0.2.0-darwin-arm64.zip`
...
[版本说明与 SHA-256 校验值](https://github.com/yumao3623/GitHub-Starter-Village/releases/tag/v0.2.0)
